...
public class ListeningController {
    ...
    @GetMapping
    public ResponseEntity<Page<ListeningResponseDTO>> findListeningWithStatusAndPagingAndSorting(
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ListeningResponseDTO> findById(@PathVariable String id) {
    ...
    @PostMapping
    public ResponseEntity<ListeningResponseDTO> create(@Valid @RequestBody ListeningRequestDTO dto) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ListeningResponseDTO> update(@Valid @RequestBody ListeningRequestDTO dto, @PathVariable String id) {
