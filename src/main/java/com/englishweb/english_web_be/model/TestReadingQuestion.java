...
public class TestReadingQuestion {
    ...
    public com.englishweb.english_web_be.model.TestReading getTestReading() {
        return TestReading;
    }

    public void setTestReading(com.englishweb.english_web_be.model.TestReading testReading) {
