...
public class TestService extends BaseService<Test,TestDTO,TestRepository> {
    ...
    public TestService(TestRepository repository, @Lazy TestVocabularyQuestionService testVocabularyQuestionService, @Lazy TestGrammarQuestionService testGrammarQuestionService, @Lazy TestSpeakingService testSpeakingService, @Lazy TestReadingService testReadingService, @Lazy TestListeningService testListeningService, @Lazy TestWritingService testWritingService, TestMixingQuestionService testMixingQuestionService) {
        super(repository);
    ...
    protected TestDTO convertToDTO(Test entity) {
        ...
        dto.setTestGrammarQuestions(testGrammarQuestionService.findAllByTestId(entity.getId()));
        dto.setTestVocabularyQuestions(testVocabularyQuestionService.findAllByTestId(entity.getId()));
