...
@Service
public class ListeningQuestionServiceImpl extends BaseServiceImpl<ListeningQuestion, ListeningQuestionDTO, ListeningQuestionRepository> implements ListeningQuestionService {
    private final ListeningServiceImpl listeningService;
    ListeningAnswerServiceImpl answerService;

    public ListeningQuestionServiceImpl(ListeningQuestionRepository repository, ListeningAnswerServiceImpl answerService, @Lazy ListeningServiceImpl listeningService) {
        super(repository);
