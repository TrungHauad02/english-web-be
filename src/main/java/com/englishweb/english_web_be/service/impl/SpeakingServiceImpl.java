...
@Service
public class SpeakingServiceImpl extends BaseServiceImpl<Speaking, SpeakingDTO, SpeakingRepository> implements SpeakingService {

    private final SpeakingConversationServiceImpl speakingConversationService;

    public SpeakingServiceImpl(SpeakingRepository repository, SpeakingConversationServiceImpl speakingConversationService) {
        super(repository);
